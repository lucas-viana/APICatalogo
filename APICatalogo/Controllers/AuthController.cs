using APICatalogo.DTOs.Autentication;
...
namespace APICatalogo.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public async Task<IActionResult> Register([FromBody] RegisterModelDTO modelDTO)
        {
            ...
            {
                var userExist = await _userManager.FindByEmailAsync(modelDTO.Email);
        ...
        public async Task<IActionResult> RefreshToken(TokenModelDTO tokenModel)
        {
            ...
            string acessToken = tokenModel.AccessToken ?? throw new ArgumentException(nameof(tokenModel));
